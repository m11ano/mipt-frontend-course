...
export default function FilmFormEntity({ state, onSend }: FilmFormEntityProps) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <Card.Root padding={"50px 70px"} boxShadow="0px 2px 2px 0px rgba(0, 0, 0, 0.25)" borderRadius={16}>
                <Card.Body>
                    <Fieldset.Root style={{ all: "unset" }}>
                        <Fieldset.Content gap="40px">
                                ...
                                <Box flex={5}>
                                    ...
                                    >
                                        <Fieldset.Root invalid={!!errors.categories}>
                                            <Fieldset.Content gap="20px" display="flex" flexDir="row" flexWrap="wrap">
                            ...
                            <Field.Root orientation="horizontal" alignItems="flex-start" invalid={!!errors.description}>
                                <Field.Label fontSize={16} fontWeight={400} flex={3} marginTop="6px">
                                    Описание
                                </Field.Label>
                                <Box flex={5}>
                                    <Textarea
                            ...
                            <Field.Root orientation="horizontal" invalid={!!errors.file}>
                                ...
                                <Box flex={5} overflow="hidden">
                                    ...
                                    />
                                    {errors.file && <Field.ErrorText>{errors.file.message}</Field.ErrorText>}
                                </Box>
                            </Field.Root>
                        </Fieldset.Content>
                    </Fieldset.Root>
